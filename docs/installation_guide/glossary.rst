...
.. glossary::
	...
	Advanced Intrusion Detection Environment (AIDE)
	    ...
	    under Linux. AIDE can be used to help track file integrity by
	    comparing a snapshot of the system's files prior to and after a
	    suspected incident. It is maintained by Rami Lehti and Pablo
	    Virolainen.

	Central Processing Unit (CPU)
	    The hardware within a computer system that carries out the
	...
	Dynamic Host Configuration Protocol (DHCP)
	    A network protocol that enables a server to assign an IP address to
	...
	Puppet
	    An Open Source configuration management tool written and maintained
	...
	Red Hat
	    ...
	    software programs included in Red Hat®Linux® are GPG signed by Red
	    Hat to indicate that Red Hat supplied them.
	...
	Secure Shell (SSH)
	    ...
	    or command execution between networked computers. SSH utilizes a
