...
<gsg-installing_simp_from_a_repository>`. Otherwise, you will probably want to
:ref:`install from the ISO <gsg-installing_simp_from_an_iso>`, which configures
the disks and partitions to be compatible with most STIGs.
