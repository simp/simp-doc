...
#. Open each of the files and follow the instructions provided within them to replace the variables. 
   ...
   - ``pupclient_x86_64.cfg``: Replace the variables noted at the op and generate and
     enter the passwords.
...
2. Add the tftpboot site manifest on your puppet server node via Hiera.
   ...
   (By default the TFTP server is the same as your puppet server so it should exists.)
