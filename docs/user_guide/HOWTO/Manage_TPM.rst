...
TPM features in SIMP:
  ...
  * Compiled TPM 1.2 and TPM 2.0 simulators
  * Taking ownership
...
pre-compiled versions of IBM's Software TPMs. The RPMs can be regenerated by
downloading the code from their respective project repositories, 
`TPM 1.2 <https://github.com/simp/simp-tpm12-simulator>` and 
`TPM 2.0 <https://github.com/simp/simp-tpm2-simulator>`. After installing 
the RPMs, the TPMs can be initialized.
